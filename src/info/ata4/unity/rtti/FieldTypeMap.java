 ...
 */
public class FieldTypeMap extends HashMap<Pair<Integer, UnityVersion>, FieldTypeNode> {
    
    private static final Logger L = LogUtils.getLogger();

    public FieldTypeNode get(int classID, UnityVersion revision) {
        return get(classID, revision, true);
    }

    public FieldTypeNode get(int classID, UnityVersion version, boolean strict) {
        FieldTypeNode fieldNode = get(new ImmutablePair<>(classID, version));
        ...
        for (Map.Entry<Pair<Integer, UnityVersion>, FieldTypeNode> entry : entrySet()) {
    ...
    public void add(int classID, UnityVersion revision, FieldTypeNode fieldNode) {
